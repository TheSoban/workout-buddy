...
const BlueprintsEdit = () => {
  ...
  return blueprint && <div>
    ...
    <BlueprintForm update={true} initialData={{name: blueprint.name, description: blueprint.description, ordered_exercises: blueprint.ordered_exercises.map(({exercise_id, exercise: {name}}) => ({exercise_id, name}))}} />;
    </div>
};
